# Resources related to the CDN Load Balancer and Cloud Storage bucket
...
# GOOGLE SAMPLE
# https://github.com/terraform-google-modules/terraform-docs-samples/blob/main/lb/external_cdn_lb_with_backend_bucket/main.tf
